    ...
    <div class="container mx-auto px-4">
      <div class="flex flex-col md:flex-row items-center justify-between gap-8">
        <div class="text-white max-w-xl">
          <h2 class="text-2xl font-bold mb-4">Stay Connected with Our Community</h2>
          <p class="mb-4">
            Join our mailing list to receive weekly devotionals, event updates, and
            spiritual resources directly in your inbox.
          </p>
          <ul class="mb-6">
            <li class="flex items-center mb-2">
              <i class="ri-checkbox-circle-line mr-2"></i> Weekly Devotionals
            </li>
            <li class="flex items-center mb-2">
              <i class="ri-checkbox-circle-line mr-2"></i> Event Reminders
            </li>
            <li class="flex items-center">
              <i class="ri-checkbox-circle-line mr-2"></i> Prayer Request Updates
            </li>
          </ul>
        </div>
