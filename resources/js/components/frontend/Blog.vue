  ...
  <section id="blog" class="py-16">
    <div class="container mx-auto px-4">
      <div class="text-center mb-12">
        <h2 class="text-3xl font-bold text-primary mb-2">Latest Articles</h2>
        ...
        <div v-for="blog in props.blogs" :key="blog.id"
          ...
          <div class="p-6">
            ...
            <Link :href="route('single.church.event.blog', blog.id)"
              class="text-primary font-medium hover:text-secondary">Read More <i class="ri-arrow-right-line"></i></Link>
          </div>
        </div>
      </div>
      <div class="text-center mt-10">
        <Link :href="route('event.blogs')"
