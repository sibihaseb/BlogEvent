<template>
  ...
  <FrontendLayout>
    <HeroSectionPage
      :heading="prayerPage?.heroheading ?? 'Prayer Request'"
      :subheading="prayerPage?.herosubheading ?? 'SHARE YOUR PRAYER REQUESTS WITH US'"
      :text="
        prayerPage?.herotext ??
        'Our compassionate and experienced prayer warriors come from diverse backgrounds, united by a shared commitment to intercede on behalf of others.'
      "
      :image="prayerPage?.heroimage"
    />
    <!-- <section class="py-16">
