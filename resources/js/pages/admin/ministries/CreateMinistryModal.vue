<template>
  <Dialog v-model:open="localOpen">
    <DialogTrigger as-child>
      <Button variant="outline">Create Ministries</Button>
    </DialogTrigger>

    <DialogContent class="sm:max-w-[500px]">
      <form @submit="submit" class="space-y-6">
        <DialogHeader class="space-y-3">
          <DialogTitle>Create Ministries</DialogTitle>
          <DialogDescription>Enter new Ministry details and save.</DialogDescription>
        </DialogHeader>
        ...
        <div class="grid gap-4">
          ...
          <DialogFooter class="gap-2">
            ...
            <Button type="submit" :disabled="form.processing">Create Ministries</Button>
          </DialogFooter>
...
const submit = (e: Event) => {
  ...
  form.post(route("ministries.store"), {
    preserveScroll: true,
    onSuccess: () => {
      form.reset();
      closeModal();
