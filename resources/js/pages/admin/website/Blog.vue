<template>
  ...
  <AppLayout>
    <div class="flex flex-1 flex-col gap-4 rounded-xl p-6 space-y-6">
      <h1 class="text-xl font-bold">Blog Page Content</h1>
...
const form = useForm({
  heroheading: props.blogPage?.heroheading ? props.blogPage?.heroheading : "",
  herosubheading: props.blogPage?.herosubheading ? props.blogPage?.herosubheading : "",
  herotext: props.blogPage?.herotext ? props.blogPage?.herotext : "",
  heroimage: props.blogPage?.heroimage ? props.blogPage?.heroimage : "",
  //   heroimage_style: "",
});
...
const submit = () => {
  form.post(route("website.blog.update"), {
    forceFormData: true,
  });
};
</script>
